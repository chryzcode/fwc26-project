  ...
  return (
    <BlogPost post={post}>
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8 rounded-r-lg">
          <h3 className="text-xl font-bold text-blue-900 mb-3">Key Highlights</h3>
        ...
        <h3 className="text-xl font-bold text-blue-900 mb-3">Massive Foot Traffic & Tourism</h3>
        <p>
        ...
        <h3 className="text-xl font-bold text-blue-900 mb-3">Diverse Customer Base</h3>
        <p>
        ...
        <h3 className="text-xl font-bold text-blue-900 mb-3">Once-in-a-lifetime Momentum</h3>
        <p>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-8 rounded-r-lg">
          <h3 className="text-xl font-bold text-blue-900 mb-3">Download Free Ebook!</h3>
          <Link href="/FWC26 Business strategy - Ebook.pdf" target="_blank" className="flex items-center gap-3 hover:bg-gray-50 p-2 rounded transition-colors">
            ...
            <div>
              <p className="font-medium text-blue-900">FWC26 Business strategy - Ebook</p>
